...
},{"./resources":10}],2:[function(require,module,exports){
/**
 * @module Passage
 */
'use strict';
...
var Resource = function(set, get, del, routes){
	return {
		set: function(path){
			// if routes.set does not contain path, return empty observable
			// how are the routes compared?
			// path: /parent/1/child/37/grandchild/2
			// route: /parent/:id/child/:key/grandchild/:name
			// does path match some route?
